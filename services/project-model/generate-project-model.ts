...
function buildAssumptions(
  ...
  if (
    users &&
    !users.toLowerCase().includes("admin")
  ) {
    assumptions.push({
  ...
  const requiredQuestions = [
    {
      ...
      reason:
        "Sin esta respuesta no se puede generar un Product Spec útil.",
      priority: "high" as const,
    },
    {
      id: "product-001",
      question:
        "¿Qué problema principal resuelve este producto?",
      reason:
        "El problema define la propuesta de valor y el alcance.",
      priority: "high" as const,
    },
    {
      id: "users-001",
      ...
      reason:
        "Los usuarios determinan roles, permisos y flujos.",
      priority: "high" as const,
    },
    {
      id: "security-001",
      question:
        "¿Qué información debe protegerse especialmente?",
      reason:
        "La seguridad debe definirse antes de decidir arquitectura final.",
      priority: "high" as const,
    },
    {
      id: "delivery-001",
      question:
        "¿Cuál sería la primera versión útil del producto?",
      reason:
        "El MVP evita sobrealcance y permite construir por etapas.",
      priority: "high" as const,
    },
  ];
...
export function generateProjectModelFromInterview(
  interview: ProjectInterview
): ProjectModel {
